...
https://home-assistant.io/components/weather.yr/
"""
import logging
...
ATTRIBUTION = "Weather forecast from yr.no, delivered by the Norwegian " \
...
def setup_platform(hass, config, add_devices, discovery_info=None):
    """Setup the Yr.no weather platform."""
...
if __name__ == '__main__':
    ...
    weather = Yr(location_name='Czech_Republic/Prague/Stodůlky')
    hourly = Yr(location_name='Czech_Republic/Prague/Stodůlky', forecast_link='forecast_hour_by_hour')

    # now = weather.forecast(as_json=True)
    ...
    for forecast in hourly.forecast(as_json=True):
        print(forecast)
